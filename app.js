...
// function filterByPrice(price) { // price
...
function isCityResident(city) {
    return users.some(resident => resident.city== city);
}
const cityNameToCheck = "New York";
const isResident = isCityResident(cityNameToCheck);
